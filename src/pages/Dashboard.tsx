...
type DashboardTab = 'mon' | 'department' | 'filiale' | 'global'
 ...
 * - reports.view_filiale : accès au tableau de bord de sa filiale
 ...
 * - Tableau de bord de la filiale : agrégats de la filiale (Reports, scope filiale)
...
const UnifiedDashboard = () => {
  ...
  const hasViewFiliale = hasPermission('reports.view_filiale')
  const hasViewGlobal = hasPermission('reports.view_global')
  const hasReportAccess = hasViewTeam || hasViewFiliale || hasViewGlobal
  ...
  return (
    <div className="space-y-4">
      {/* Barre d'onglets : Mon tableau de bord | Tableau de bord du département | Tableau de bord de la filiale | Dashboard global */}
      ...
      {activeTab === 'filiale' && (
        <Reports
          reportScope="filiale"
          title="Tableau de bord de la filiale"
          subtitle="Vue d'ensemble des tickets et indicateurs de votre filiale"
        />
      )}
      {activeTab === 'global' && (
        <Reports
