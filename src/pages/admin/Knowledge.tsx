    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between md:gap-4">
        <div className="order-2 md:order-1 flex-1 min-w-0 w-full">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100">Base de connaissances</h1>
          <div className="flex items-center gap-2 mt-1">
            <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base">Gérez les articles et ressources de la base de connaissances</p>
            <button
