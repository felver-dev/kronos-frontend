    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between md:gap-4">
        <div className="order-2 md:order-1 w-full min-w-0">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 break-words">Projets</h1>
        ...
        <div className="order-1 md:order-2 flex-shrink-0 w-full md:w-auto">
          <PermissionGuard permissions={['projects.create']}>
            <button onClick={() => setIsCreateModalOpen(true)} className="btn btn-primary flex items-center w-full sm:w-auto justify-center">
